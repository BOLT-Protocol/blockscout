defmodule BlockScoutWeb.Schema.Scalars do
  ...
  @desc """
  The smallest fractional unit of TideBit. Using wei instead of TideBit allows code to do integer match instead of using
  floats.

  TideBit likes Ethereum, See [Ethereum Homestead Documentation](http://ethdocs.org/en/latest/ether.html) for examples of various denominations of wei.
